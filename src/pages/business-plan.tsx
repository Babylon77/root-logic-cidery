  ...
  return (
    <Layout>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-center mb-12">Market Research & Supporting Documents</h2>
          
          <div className="bg-white p-8 rounded-lg shadow-lg mb-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Research Overview</h3>
            <p className="text-lg text-gray-600 mb-6">
              Our business plan is supported by comprehensive market research and analysis conducted specifically for the craft cider industry and our Wantage, NJ location. These studies provide detailed insights into buyer behavior, wholesale market conditions, and location-specific opportunities.
            </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Premium Market Positioning</h4>
                    <p className="text-gray-600">Heritage apple varieties and organic certification position us in the premium segment with 15-25% higher margins than conventional ciders.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Target Demographics</h4>
                    <p className="text-gray-600">Primary buyers are 25-45 years old, college-educated, with household incomes above $75k, prioritizing quality and sustainability over price.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Distribution Opportunities</h4>
                    <p className="text-gray-600">Strong wholesale opportunities in NYC metro area, with craft beer bars and upscale restaurants showing 20% annual growth in cider sales.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Strategic Location</h4>
                    <p className="text-gray-600">Wantage, NJ provides access to NYC metro market (60 miles) while maintaining rural authenticity that resonates with target customers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Regulatory Environment</h4>
                    <p className="text-gray-600">New Jersey's Plenary Winery License allows self-distribution up to 50,000 gallons annually, providing significant cost advantages over traditional distribution.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2">Tourism Potential</h4>
                    <p className="text-gray-600">Sussex County attracts 2.3 million visitors annually for agritourism, providing strong foundation for direct-to-consumer sales and tasting room operations.</p>
                  </div>
                </div>
              </div>
            </div>
